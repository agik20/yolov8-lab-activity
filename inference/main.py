...
class Config:
    # Path configurations
    VIDEO_PATH = "preprocessing/data/input/0614.mp4"
    POSE_MODEL_PATH = "preprocessing/data/model/pose-70s.engine"
    OBJECT_MODEL_PATH = "preprocessing/data/model/v8s-object.engine"

    OUTPUT_POSE_BASE = "/var/www/html/frontend/output/pose"
    OUTPUT_OBJ_BASE = "/var/www/html/frontend/output/object"
    OUTPUT_FULLROOM = "/var/www/html/frontend/output/room-view"
    OUTPUT_FRAMES = "/var/www/html/frontend/output/frames"
