...
# === SESUAIKAN DIREKTORI ===
images_dir = Path("backend/preprocessing/data/output/images")
labels_dir = Path("backend/preprocessing/data/output/labels")
output_base = Path("backend/training/datasets")
