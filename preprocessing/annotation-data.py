...
# Path
model_path = 'backend/training/output/pose_exp12/weights/best.pt'
image_root = 'backend/preprocessing/data/output/images'
output_root = 'backend/preprocessing/data/output/labels'
